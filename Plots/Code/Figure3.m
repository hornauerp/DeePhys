...
yticklabels(feature_groups([5:8,1:4,9]))
...
bc = boxchart(s_ap, age_x_vals, y_pred,'GroupByColor',age_color_idx,'MarkerSize',1);
hold on
p = plot(s_ap, [0 max(age_x_vals)*1.2],[0 max(y_test)*1.2],'k--'); p.Color(4) = 0.3;
