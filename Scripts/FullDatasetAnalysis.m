...
%,{'Mutation','WT'} 
rg_params.Selection.Exclusion = {{'DIV',12},{'Treatment',"ASO","LNA"},{'Mutation',"LRRK2","GBA"},{'PlatingDate',221207,221208}}; %Cell array of cell arrays with fieldname + value
...
normalization_var = "Source"; %Use to normalize by groups of the normalization_var (e.g. PlatingDate would normalize by individual batches)
...
full_rg.reduceDimensionality(dr_level, dr_method, n_dims, unit_features, network_features, feature_names, useClustered,...
...
% pooling_vals = {{"WT","A53T","Control","SNCA"},{{"Untreated","ntLNA"},{"LNA"}}};
figure("Color","w");
[cluster_idx, group_labels_comb] = full_rg.plot_true_clusters(dr_level, dr_method, grouping_var, pooling_vals, false, 20, 300, 5, othercolor('Spectral9',4));
