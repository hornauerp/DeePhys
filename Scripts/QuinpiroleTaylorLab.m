...
mapSz = 200;
figure("Color","w");
[cluster_idx, group_labels_comb] = qp_taylor.plot_true_clusters(dr_level, dr_method, grouping_var, pooling_vals, plot_centroid, nodeSz, mapSz, 4, stacked_color);
...
qp_taylor.clusterByFeatures(dr_method,dr_level,clust_method,0.4);
