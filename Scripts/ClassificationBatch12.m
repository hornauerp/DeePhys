...
clf_tolerance = 1;
result = batch12group.classifyByFeatureGroups(clf_level, clf_alg, clf_classification_var, clf_classification_test_val, clf_network_features, clf_unit_features, clf_useClustered,... 
...
clf_objects = horzcat(result.objects);
