...
%,{'Mutation','WT'}
rg_params.Selection.Exclusion = {{'DIV',12},{'Treatment',"ASO"},{'Mutation',"GBA"}};%,{'Treatment',"LNA"}};%,{'ChipID',"4135_0","4043_0"}}; %Cell array of cell arrays with fieldname + value
taylor_untreated = RecordingGroup(rec_array, rg_params);
...
taylor_untreated.reduceDimensionality(dr_level, dr_method, n_dims, unit_features, network_features, useClustered,...
...
figure("Color","w");
[cluster_idx, group_labels_comb] = taylor_untreated.plot_true_clusters(dr_level, dr_method, grouping_var);
...
clf_tolerance = 1;
clf_result = taylor_untreated.classifyByFeatureGroups(clf_level, clf_alg, clf_classification_var, clf_classification_test_val, clf_network_features, clf_unit_features, clf_useClustered,... 
