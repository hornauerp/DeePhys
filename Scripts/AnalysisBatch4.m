...
%,{'Mutation','WT'}
rg_params.Selection.Exclusion = {{'DIV',12},{'Treatment',"ASO"}}; %Cell array of cell arrays with fieldname + value
...
batch4_group.clusterByFeatures(dr_method,dr_level,clust_method,4);

%%
batch4_group.plot_cluster_waveforms(clust_method);

%%
batch4_group.assignUnitClusterIdx(clust_method,true);
