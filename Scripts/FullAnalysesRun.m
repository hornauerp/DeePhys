...
root_path = "/net/bs-filesvr02/export/group/hierlemann/intermediate_data/Maxtwo/phornauer/iNeurons/";
% path_logic = {'SCR*','*','*','w*'}; %Each cell corresponds to one subdirectory
% path_logic = {'DeePhysS*','*','*','w*'};
% path_logic = {'M*','w*'};
path_logic = {'230328','*','w*','sorted','sorter_output'};
...
lookup_path = "/home/phornauer/Data/iNeurons/iNeurons_batch2.xlsx";
...
save("/net/bs-filesvr02/export/group/hierlemann/intermediate_data/Maxtwo/phornauer/iNeurons/230328/rec_array.mat", "rec_array")